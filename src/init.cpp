...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 19995 or testnet: 119995)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 19994 or testnet: 119994)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Capitalcoin Wiki for SSL setup instructions)") + "\n" +
